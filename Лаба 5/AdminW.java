    ...
    public AdminW() {
        ...
        loadButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (jTextField.getText().equals("")) {
                    JOptionPane.showMessageDialog(AdminW.this, "Сначала выберите файл для сохранения/загрузки ", "Ошибка", JOptionPane.ERROR_MESSAGE);
        ...
        chooseFileButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int result = jFileChooser.showOpenDialog(AdminW.this);
        ...
        editWinnersButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    ConcertSystem.adminW.setEnabled(false);
                    ...
                    ConcertSystem.adminW.setEnabled(true);
                    ConcertSystem.adminW.setVisible(true);
